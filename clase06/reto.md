# Clase 6 · Reto — Análisis bivariado de 25.000 resultados del Saber Pro
...
4. Guárdelo como `reto_clase06_APELLIDO.ipynb` y súbalo antes del inicio de la clase 7.
...
- El `demo.ipynb` de esta misma clase tiene el marco bivariado aplicado paso por paso, incluido
