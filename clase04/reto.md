# Clase 4 · Reto — Limpiar indicadores de salud materno-infantil
...
- Detección de outliers con el rango intercuartílico. Se ve formalmente en la clase 5.
...
4. Súbalo al aula virtual con el nombre `clase04_reto_APELLIDO.ipynb`.
5. Fecha límite: antes del inicio de la clase 5.
