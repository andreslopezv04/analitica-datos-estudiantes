# Clase 12 · Reto — Inferencia sobre la educación en Colombia

**Curso:** Analítica de Datos · Universidad Cooperativa de Colombia
**Momento 3 · Clase 12 de 15**
...
**No hay ningún otro archivo de datos para esta clase.** No busques una carpeta `data/` en `clase12/`:
no existe.
...
- `departamento` está inconsistente (`'Guainia'` y `'Guainía'` son el mismo). El paso 0 lo
  estandariza con la receta de la clase 4, pero **la llave sigue siendo `c_digo_departamento`**:
...
Para el proyecto final de la clase 14 necesitas, como mínimo, **dos intervalos de confianza y una
